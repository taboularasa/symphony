...
7. Check the PR body against `.github/pull_request_template.md` and fix stale
...
if rg -q '<!--' "$tmp_pr_body"; then
  echo "PR body still contains template placeholder comments." >&2
  rm -f "$tmp_pr_body"
  exit 1
fi
rm -f "$tmp_pr_body"
